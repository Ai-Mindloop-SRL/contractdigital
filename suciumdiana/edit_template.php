    ...
    if (empty($template_name)) {
        ...
        if ($stmt->execute()) {
            ...
            if (!$is_edit) {
                ...
                // ✅ FIX: Accept both uppercase [NUME_FIRMA] and lowercase [nume_firma]
                preg_match_all('/\[([A-Za-z_0-9]+)\]/', $template_content, $placeholder_matches);
...
// ✅ FIX: Accept both uppercase and lowercase placeholders
preg_match_all('/\[([A-Za-z_0-9]+)\]/', $template_content, $matches);
