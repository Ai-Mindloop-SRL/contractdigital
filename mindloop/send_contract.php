...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO contracts (site_id, template_id, contract_content, signing_token, unique_token, recipient_name, recipient_email, status, sent_at) VALUES (?, ?, ?, ?, ?, ?, ?, 'pending', NOW())");
