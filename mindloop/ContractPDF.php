    ...
    private function generateNivel1MetadataHTML($data) {
        ...
        <div style="font-family: DejaVu Sans, sans-serif; font-size: 10pt; line-height: 1.6;">
            <div style="text-align: center; margin-bottom: 20px; padding: 15px; background: #f0f0f0; border-radius: 5px;">
                <h2 style="margin: 0; color: #2c3e50; font-size: 14pt;">🔐 DETALII SEMNĂTURĂ ELECTRONICĂ</h2>
                <p style="margin: 5px 0 0 0; color: #7f8c8d; font-size: 9pt;">Metadate conform NIVEL 1 (SES+) - eIDAS/eSign Compliant</p>
            </div>
            
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 15px;">
                <tr>
                    <td style="width: 40%; padding: 8px; border: 1px solid #ddd; background: #f8f9fa; font-weight: bold;">✅ Data și ora semnării:</td>
                ...
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd; background: #f8f9fa; font-weight: bold;">🌐 Adresă IP:</td>
                ...
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd; background: #f8f9fa; font-weight: bold;">📐 Rezoluție ecran:</td>
            ...
            <div style="margin-bottom: 15px; padding: 12px; background: #e8f5e9; border-left: 4px solid #4caf50; border-radius: 3px;">
                <h3 style="margin: 0 0 8px 0; color: #2e7d32; font-size: 11pt;">✓ Consimțământ Explicit (GDPR)</h3>
                <p style="margin: 3px 0;">✓ Am citit și înțeles în totalitate termenii și condițiile contractului</p>
                <p style="margin: 3px 0;">✓ Sunt de acord să semnez prin mijloace electronice (valoare juridică egală cu semnătura olografă)</p>
                <p style="margin: 3px 0;">✓ Sunt de acord cu procesarea datelor personale conform GDPR (Regulamentul UE 2016/679)</p>
            </div>
            ...
            <div style="margin-bottom: 15px; padding: 12px; background: #fff3e0; border-left: 4px solid #ff9800; border-radius: 3px;">
                ...
                <p style="margin: 3px 0; font-size: 9pt;"><strong>Hash contract (înainte de semnare):</strong><br/><code style="font-family: monospace; font-size: 8pt;">' . htmlspecialchars($contract_hash) . '</code></p>
                <p style="margin: 3px 0; font-size: 9pt;"><strong>Hash PDF final (după semnare):</strong><br/><code style="font-family: monospace; font-size: 8pt;">' . htmlspecialchars($pdf_hash) . '</code></p>
                <p style="margin: 8px 0 0 0; font-size: 8pt; color: #666;"><em>Aceste hash-uri garantează că documentul nu a fost modificat după semnare. Orice modificare va genera un hash diferit.</em></p>
            </div>
            
            <div style="margin-top: 20px; padding: 10px; background: #f5f5f5; border-radius: 3px; text-align: center; font-size: 8pt; color: #666;">
                <p style="margin: 0;"><strong>Semnătură Electronică Conformă:</strong> Regulament eIDAS (UE) Nr. 910/2014 | Legea 455/2001 (RO)</p>
                <p style="margin: 5px 0 0 0;">Document generat de AI Mindloop Contract System | Hash-uri verificabile independent</p>
            </div>
        </div>
        ';
